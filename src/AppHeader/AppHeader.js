...
import { Menu, Icon, Dropdown, Modal, Checkbox, Button, Grid, TextArea, Input } from "semantic-ui-react";
          ...
          <Grid divided='vertically'>
            <Grid.Row columns={2}>
              ...
              <Grid.Column>
                ...
                <Checkbox ref={this.checkboxShowWorkbaskets} label="Show Workgroup Workbaskets" defaultChecked={this.props.appSettings.bshowWorkgroupBaskets} />
              </Grid.Column>
            </Grid.Row>
          </Grid>
          <Grid>
